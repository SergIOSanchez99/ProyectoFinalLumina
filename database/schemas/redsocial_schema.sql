...
-- Red Social Universitaria Lumina - Esquema completo
-- Alineado con: foro-estudiantes, microservicios-basico, frontend
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- 4. PUBLICACIONES / TEMAS (temas del foro)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 5. TAGS DE PUBLICACIONES (tags por publicación)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 6. COMENTARIOS (con soporte para anidados y solución marcada)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 7. REACCIONES (like, love, apoyo, genial, interesante - sobre temas o comentarios)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 9. APUNTES / NOTAS (apuntes colaborativos por curso)
-- -----------------------------------------------------------------------------
...
-- Publicaciones con estadísticas
...
INSERT IGNORE INTO cursos (id, nombre, codigo, descripcion, docente) VALUES
(1, 'General', 'GEN001', 'Curso general para publicaciones y debates', NULL);

-- Logros de ejemplo
INSERT IGNORE INTO logros (nombre, descripcion, icono, puntos_requeridos) VALUES
